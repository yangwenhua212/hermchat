...
- **历史对话**：顶栏时钟图标；标题取首条用户句；点开可回看（Hermes 服务端上下文不自动恢复；HTTP 兼容 / 网关续聊带本会话短历史）  
- **外观**：主题色驱动气泡与聊天页渐变（系统默认绿 / 浅天蓝等）；可相册选图、搜索下载壁纸；一键恢复系统默认绿  
- **复制**：气泡文字可长按选中复制  
...
- 资源库、流式对话、多 Agent、本地多会话历史、新建对话换 Session、聊天主题/背景壁纸、唤醒（自定义词 / 页内免喊词 / 开机恢复）  
